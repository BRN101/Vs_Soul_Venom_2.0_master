...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		else if(PlayState.SONG.song.toLowerCase() == 'sighofdespair' || PlayState.SONG.song.toLowerCase() == 'getout' || PlayState.SONG.song.toLowerCase() == 'soulvenom')
		{
			portraitLeft = new FlxSprite(-600, 60);
			portraitLeft.frames = Paths.getSparrowAtlas('portraits/venomPortrait', 'shared');
		...
		if (PlayerSettings.player1.controls.ACCEPT && dialogueStarted == true)
		{
			...
			if (dialogueList[1] == null && dialogueList[0] != null)
			{
				if (!isEnding)
				{
					...
					if (PlayState.SONG.song.toLowerCase() == 'senpai' || PlayState.SONG.song.toLowerCase() == 'thorns' || PlayState.SONG.song.toLowerCase() == 'sighofdespair' || PlayState.SONG.song.toLowerCase() == 'getout' || PlayState.SONG.song.toLowerCase() == 'soulvenom')
